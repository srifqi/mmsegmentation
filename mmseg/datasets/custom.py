...
def mmcv_scandir(dir_path, suffix=None, recursive=False):
...
class CustomDataset(Dataset):
    ...
    def load_annotations(self, img_dir, img_suffix, ann_dir, seg_map_suffix,
        ...
        if split is not None:
            ...
            for img in mmcv_scandir(img_dir, img_suffix, recursive=True):
        ...
        print_log(f'Loaded {len(img_infos)} images', logger=None)
        return img_infos
